...
public class SQLiteDialect extends Dialect {
    ...
    protected String columnType(int sqlTypeCode) {
        switch (sqlTypeCode) {
            case DECIMAL:
                return getVersion().isBefore(3)
                        ? columnType(SqlTypes.NUMERIC)
    ...
    private static class SQLiteUniqueDelegate extends AlterTableUniqueDelegate {
        ...
        public String getColumnDefinitionUniquenessFragment(
                Column column, SqlStringGenerationContext context) {
            return " unique";
        }
    }
    ...
    public void initializeFunctionRegistry(FunctionContributions functionContributions) {
        ...
        functionContributions
                .getFunctionRegistry()
                .namedDescriptorBuilder("format", "strftime")
    ...
    @Override
    public void appendDateTimeLiteral(
            SqlAppender appender, Date date, TemporalType precision, TimeZone jdbcTimeZone) {
        switch (precision) {
            case DATE:
                appender.appendSql("date(");
